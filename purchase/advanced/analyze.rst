...
If your company regularly purchase products, you have several reasons to track and analyze your
...
.. note:: When you have to select a period, you can use multiple years, and, with at least one year
   selected, multiple quarters and the three most recent months.

.. tip:: If you use the *Order Date* or *Confirmation Date* filters, the *Comparison* feature
   appears next to *Filters*. It enables you to compare the period you filtered with the previous
   one.
...
.. tip:: To avoid having to recreate custom filters every time, save them by clicking on
...
.. tip:: You can insert your pivot table's data directly in the Spreadsheet app or export it as an
   Excel file.
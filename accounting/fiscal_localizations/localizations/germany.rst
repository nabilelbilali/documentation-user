...
The key words when it comes to GoBD are: **traceable, verifiable, true, clear and continuous**. In
short, you need to have audit-proof archiving in place and Odoo provides you with the means to
...
#. | **Completeness**
   | All financial data must be recorded in the system, there can be no gaps. Odoo ensures that
     ...
     automatically, it remains the responsibility of the user to encode completely all vendor bills
...
In the case of a fiscal control, the fiscal authority can request 3 levels of access to the
accounting system (Z1, ZZ2, Z3), going from an access from the interface e to the handover of the
